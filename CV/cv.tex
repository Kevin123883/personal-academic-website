...
%	Generated from data/about.json by scripts/build-cv.mjs — edit the JSON,
%	then run `npm run cv`. Defines \name, \position, \mobile, \email,
%	plus \cvname and \cvdate used in the footer.
%-------------------------------------------------------------------------------
\input{cv/_personal.tex}
